...
import { Wrench, Search, MessageSquare, Bell, ArrowRight, ShieldCheck, Smartphone, MapPin } from "lucide-react";
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-slate-900 font-sans selection:bg-indigo-100 dark-page">

      {/* HERO SECTION */}
      <section className="w-full min-h-screen align-cneter relative overflow-hidden pt-24 pb-32 px-6 border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-5 max-w-2xl mx-auto">
            <button
              ...
              className="flex-1 px-10 py-5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold flex items-center justify-center gap-3 transition-all shadow-xl shadow-indigo-200"
            >
