...
function MyReport() {
  // Added 'addComment' from context (assuming you have a function to save comments)
        ...
        <div className="mb-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Manage your submitted issues and track their status.
            </p>
          </div>
          <div className="bg-white px-3 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-600 shadow-sm">
            ...
            {report && report.length > 0 ? (
              report.map((item, i) => (
                <div key={item._id || i} className="flex flex-col">
                  {/* Main Row */}
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-gray-50 transition-colors duration-200 group">
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1">
                      <div className="flex items-center gap-2 text-[10px] text-gray-500 uppercase font-bold">
                        <span className="w-12">Reported:</span>
                    ...
                    <div className="md:col-span-2 flex md:justify-center justify-end gap-2">
                      <button
                        onClick={() => {
                          if (window.confirm("Are you sure?")) deleteIssue(item._id);
                        }}
