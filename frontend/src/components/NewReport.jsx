    ...
    try {
      ...
      if (response.data.success) {
        ...
        await axios.post(`${url}/notification/create`, {
          ...
          content: `We have received your report: "${response.data.issue.content.substring(0, 20)}...". Thank you.`,
    ...
    <div className="min-h-screen  sm:ml-64ml-0 w-full bg-gray-50 flex items-center justify-center p-6 font-sans">
      ...
      <div className="max-w-4xl w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-3/5 p-8 md:p-10 flex flex-col">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Submit Report</h1>
            <p className="text-gray-500 text-sm">
              Found an issue? Please describe it below and attach a photo so we can resolve it quickly.
            </p>
          </div>
          ...
          <form onSubmit={submitReport} className="flex-1 flex flex-col gap-6">
            ...
            <div className="md:hidden">
              <button
                ...
                className="w-full py-3 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
              >
                <Upload size={20} />
            ...
            <div className="mt-auto pt-4">
              <button 
                ...
                className={`
                  ...
                  ${isLoading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 hover:shadow-blue-600/40'}
                `}
              >
                {isLoading ? (
                  <>Processing...</>
        ...
        <div className="w-full md:w-2/5 bg-gray-50 p-8 border-l border-gray-100 hidden sm:flex flex-col justify-center items-center relative">
          ...
          <div 
            ...
            className={`
              ...
              ${selectedImage ? 'border-blue-500 bg-white shadow-md' : 'border-gray-300 hover:border-blue-400 hover:bg-white'}
            `}
          >
            {selectedImage ? (
              <>
