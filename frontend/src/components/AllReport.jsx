  ...
  return (
    <div className="min-h-screen ml-64 w-full bg-gray-50 p-6 md:p-10 font-sans text-gray-800">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Report Archive</h1>
          <p className="text-gray-500 mt-1">View and manage the complete history of submitted reports.</p>
        </div>
            ...
            filteredReports.map((report, i) => (
              ...
              >
                ...
                <div className="col-span-2">
                  <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusStyle(report.status)}`}>
                    {report.status}
                  </span>
                </div>
                ...
                <div className="col-span-3 text-xs text-gray-500 space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Posted: <span className="text-gray-700">{updateTime(report.createdAt)}</span></span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock size={12} className="text-gray-400" />
                    <span>Updated: <span className="text-gray-700">{updateTime(report.updatedAt)}</span></span>
                  </div>
                </div>
             ...
             <div className="py-20 text-center flex flex-col items-center">
                ...
                <p className="text-gray-500 text-sm">Your search did not return any results.</p>
             </div>
          )}
        </div>
      </div>
