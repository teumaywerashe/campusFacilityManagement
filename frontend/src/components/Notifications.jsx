...
function Notifications() {
  ...
  // Optional: Function to handle "Mark All Read" if your backend supports it
  const handleMarkAllRead = () => {
    // Logic to loop through unread and mark them, or call a bulk API endpoint
    console.log("Marking all as read...");
  };

  return (
    <div className="min-h-screen ml-64 w-full bg-gray-50/50 p-4 md:p-8 font-sans">
